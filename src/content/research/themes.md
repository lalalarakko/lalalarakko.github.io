---
# ============================================================
# research/themes.md — 5つの研究テーマ
# 各テーマ: title_en, title_ja, lead_en, detail_en, text_ja
# ============================================================

themes:
  - id: 1
    title_en: "The Evolution of Human Cooperation and Cultural Group Selection"
    title_ja: "人間の協力の進化と文化的集団淘汰"
    lead_en: |
  ...
  - id: 2
    title_en: "Cumulative Cultural Evolution and the Emergence of Structure"
    title_ja: "累積的文化進化と構造の創発"
    lead_en: |
  ...
  - id: 3
    title_en: "Wisdom of Crowds and the Design of Epistemic Democracy"
    title_ja: "集合知と認識論的民主主義の設計"
    lead_en: |
    ...
    text_ja: |
      多様な個人の意見を集約することで、最も優れた個人の能力をも凌駕する高度な判断が可能となることが知られています。これは「集合知」と呼ばれる現象です。しかし、人々が同じ情報源に依存したり、互いに影響し合って意見に相関が生じると、集合知は容易に損なわれます。

      私は、集合知がどのような条件下で生じるか、集合知の成立を促進する制度や仕組みを探究しています。この問いは、政治哲学において論じられてきた「認識論的民主主義」に実証的・理論的な基盤を提供するものです。集団意思決定の行動実験やコンピュータ・シミュレーションを通して、集合知の発生条件や、集合知の発生を頑健に促進する仕組みや制度の設計について研究しています。

  - id: 4
    title_en: "Ecological Rationality and the Evolution of Adaptive Learning"
    title_ja: "生態学的合理性と適応的学習の進化"
    lead_en: |
      Human judgment is often described as biased or irrational, yet many such tendencies may be adaptive responses to uncertainty. I study how cognition and learning evolve under ecological pressures, with particular attention to reinforcement learning and decision-making under risk.
    detail_en: |
    ...
    text_ja: |
      人間は、不確実で変動の激しい環境の中で、いかにして適応的な意思決定を行っているのでしょうか。進化の視点から見れば、一見すると不合理に見える人間の判断の偏りも、限られた情報と認知資源の中で生き抜くために磨かれた「適応的道具箱（Adaptive Toolbox）」として再評価することができます。

      私は、「生態学的合理性（Ecological Rationality）」の観点から、個人の認知や学習能力がいかに進化してきたのかを探求しています。特に着目しているのは、人間が未知の環境に適応するための基盤となる「強化学習」などのメカニズムです。計算論的モデルや進化シミュレーションを用い、リスクや変動の激しい環境下でどのような学習規則が適応的に進化し、結果として人間の意思決定の基盤（リスク選好など）を形成してきたのかを検討しています。

  - id: 5
    title_en: "The Computational Empiricism of Morality and Social Norms"
    title_ja: "道徳と社会規範の計算論的経験主義"
    lead_en: |
    ...
    text_ja: |
      道徳や社会規範には、人間に特有の生得的な基盤があるとしばしば考えられてきました。たとえば、「人間は何をすべきと感じるか」や「規範だと認識したら、自ら進んで遵守しなければならないと感じる（規範の内面化）」といった心の性質に、進化の過程で形成された特有の基盤を想定する立場です。

      私は、こうした生得論的アプローチ（Nativist view）の役割を、道徳における学習や経験の役割を重視する経験主義（Empiricism）の立場から再評価しています。具体的には、強化学習やベイジアン計算論モデルといった手法を用いて道徳や規範における経験主義を数理的に定式化し、「一見すると高度な道徳性が、実は領域一般的な学習メカニズムからどこまで創発しうるのか」を検討しています。これにより、道徳や規範が成立するために真に必要な、最小限の生得的基盤とは何かを探究しています。
---
