...
books:
  ...
  - year: 2021
    ...
    book_en: 'Encyclopedia of Human Behavior from Evolutionary Perspectives'
    editors_en: 'Oda, R., Hashiya, K., Ohtsubo, Y., & Hiraishi, K. (Eds.)'
  ...
  - year: 2017
    ...
    book_en: 'Japanese translation of "A cooperative species: Human Reciprocity and its Evolution" by S. Bowles & H. Gintis'
    publisher_en: 'NTT Publishing'
    authors_ja: '竹澤 正哲・高橋 伸幸・大槻 久・稲葉美里・波多野礼佳'
    chapter_ja: '監訳'
    book_ja: 'サミュエル・ボウルズ、ハーバート・ギンタス(著)協力する種:制度と心の共進化'
    publisher_ja: 'NTT出版'
    isbn: '4757122896'
  ...
  - year: 2016
    ...
    authors_ja: '竹澤 正哲'
    chapter_ja: '解説'
    book_ja: 'アレックス・メスーディ(著） 野中 香方子(訳）文化進化論:ダーウィン進化論は文化を説明できるか'
    publisher_ja: 'NTT出版'
    isbn: '4757143303'
  ...
  - year: 2010
    ...
    editors_en: 'Japanese Society of Social Psychology (Ed.)'
